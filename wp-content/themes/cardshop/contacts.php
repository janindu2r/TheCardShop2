...
<div class="container">
	<div class="contacts-wrapper">
		<div class="col-md-8 vrl">
			...
			<br>
			<p class="contacts-desc" style="margin-bottom:30px;">Even if there is something you have always wanted to experience and can't find it on combadi, let us know and we peomise well do our best to find it you and send you there</p>
			<form class="contact-form-row1">
				...
				<textarea rows="6" class="form-control" id="textarea" name="textarea">default text</textarea>
			</form>
		</div>
